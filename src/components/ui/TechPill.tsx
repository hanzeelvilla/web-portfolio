...
export const TechPill = ({ tech }: TechPillProps) => {
  return (
    <div
      ...
      className="flex items-center justify-center gap-3 rounded-md bg-slate-50 px-3 py-2 text-sm font-medium text-slate-800 transition-colors duration-300 group hover:bg-slate-100 hover:text-(--tech-hover-color) min-w-30"
    >
      <tech.Icon
