...
export const Hero = () => {
  return (
    <section className="mx-auto flex max-w-6xl flex-col items-center justify-center gap-6 px-4 text-center md:flex-row md:text-left">
      <div className="flex flex-col items-center md:items-start gap-2">
        <h1 className="text-4xl font-bold tracking-tight">Hanzeel Villa</h1>
        <p className="text-lg font-medium text-slate-600">Software Engineer</p>
        <p className="text-center md:text-left max-w-2xl">
          Software Engineer bridging the gap between digital systems and the
          physical world. I specialize in crafting robust, high-performance web
          applications powered by TypeScript and the MERN stack. Driven by
